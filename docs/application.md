...
Claude ids use `claude:` and Antigravity ids use `agy:`. Changing provider selects that pane's
conversation for the destination provider. History merges the providers' workspace catalogs.
