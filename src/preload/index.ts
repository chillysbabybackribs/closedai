...
const api: ClosedaiApi = {
  ...
  browser: {
    ...
    newTabToRight: (id: string) => ipcRenderer.invoke('browser:newTabToRight', id),
    openTab: (input: string) => ipcRenderer.invoke('browser:openTab', input),
    closeTab: (id: string) => ipcRenderer.invoke('browser:closeTab', id),
    closeOtherTabs: (id: string) => ipcRenderer.invoke('browser:closeOtherTabs', id),
    closeTabsToRight: (id: string) => ipcRenderer.invoke('browser:closeTabsToRight', id),
    duplicateTab: (id: string) => ipcRenderer.invoke('browser:duplicateTab', id),
    reloadTab: (id: string) => ipcRenderer.invoke('browser:reloadTab', id),
    renameTab: (id: string, title: string | null) => ipcRenderer.invoke('browser:renameTab', id, title),
  ...
  chat: {
    ...
    listChats: () => ipcRenderer.invoke('chat:listChats'),
