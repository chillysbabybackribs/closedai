...
import { Check, ChevronDown, ChevronRight, Square, Trash2, X } from 'lucide-react'
import type { ChatController } from '../chat-controller.js'
import { formatChatTime, formatMessageCount } from './agent-format.js'
import type { FoldSet } from './agent-fold-state.js'
...
function DiffBadge({ added, removed }: { added: number; removed: number }): JSX.Element | null {
