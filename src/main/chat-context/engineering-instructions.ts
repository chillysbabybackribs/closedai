...
const COMMON_ENGINEERING_INSTRUCTIONS = [
  ...
  'Lines already read this turn stay in context: when more of that file is needed, read only the lines outside them, and re-read a range only after editing it.',
