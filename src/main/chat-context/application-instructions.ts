...
export const APPLICATION_INSTRUCTIONS = [
  ...
  'Use search.run for parallel queries/source reading; search.read waits for updates and retrieves evidence. presentation=live opens a browser tab alongside research. Finish reading before ending the turn.',
