...
const INSTRUCTIONS = [
  ...
  'Work until the request is handled. When asked for a change, make it now; never hand back a diff or ask whether to begin. If a tool fails, read the error and retry or switch tools.',
