...
export const UI_CONTROLS = {
  ...
  'composer.model-provider': "Open a provider's models in the model menu; item is the provider",
  'composer.model-item': 'Choose a model; item is the model id',
  'composer.model-more': "Toggle a provider's submenu between its top models and all of them; item is the provider",
