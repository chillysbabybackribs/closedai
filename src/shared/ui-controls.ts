...
export const UI_CONTROLS = {
  ...
  'layout.new-chat': 'Add and select a fresh conversation tab in this tile, preserving its existing tabs, other tiles and split sizes; item is the active chat id',
