...
export const UI_CONTROLS = {
  ...
  'drawer.row-accept': 'Accept a review-queue row; item is the row id',
  'drawer.row-dismiss': 'Dismiss a review-queue row; item is the row id',
  'drawer.row-stop': 'Stop a running agent row; item is the row id',
  'drawer.row-delete': 'Ask to delete a row; item is the row id',
  ...
  'chat.menu-item': 'Chat actions row; item is new-chat, history, continue, tools, or trace',
  ...
  'settings.decrease': 'Decrease an appearance value; item is chat-font-size or chat-zoom',
  'settings.range': 'Appearance slider; item is chat-font-size or chat-zoom',
  'settings.increase': 'Increase an appearance value; item is chat-font-size or chat-zoom'
} as const
