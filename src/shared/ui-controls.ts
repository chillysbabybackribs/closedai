...
export const UI_CONTROLS = {
  ...
  'credentials.add': 'Open the add-credential wizard',
  'credentials.step': 'Jump to an already-reached wizard step; item is select, details, or review',
  'credentials.service': 'Select or clear a service in the wizard grid; item is the service id',
  'credentials.label': 'Name the vault entry for a service; item is the service id',
  ...
  'credentials.docs': 'Open the provider console that mints this credential; item is the service id',
  'credentials.back': 'Go to the previous wizard step, or cancel from the first',
  'credentials.next': 'Validate this wizard step and advance',
  'credentials.save': 'Write the reviewed credentials to the encrypted vault',
  'credentials.cancel': 'Leave the wizard and return to the vault list',
